...
## qdisc_run_begin() and qdisc_run_end()：仅设置 qdisc 状态位
...
## qdisc_restart：从 qdisc 队列中取包，发送给网络驱动
...
### dequeue_skb()：从 qdisc 队列取待发送 skb
...
### dev_requeue_skb()：重新压入 qdisc 队列，等待下次发送
...
### net_tx_action() completion queue：待释放 skb 队列
...
### net_tx_action output queue：待发送 skb 队列
