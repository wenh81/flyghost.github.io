...
Action frame隶属于管理帧，其frame body包含以下内容

![Action frame body](802.11-2016/image-20210402143824652.png)

其中Action字段**HE BSS Color change announcement frame**格式如下所示。

![HE BSS Color change announcement frame](802.11-2016/image-20210401154758894.png)

其中Category字段在802.11ax中新增如下两个定义，HE BSS Color change announcement frame选取Protected HE这个类别

![Category filed](802.11-2016/image-20210402144853923.png)

则Protected HE Action字段值如下所示，对应value=0，为颜色更改公告。

![image-20210402145037669](802.11-2016/image-20210402145037669.png)
